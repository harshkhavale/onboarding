...
function addRelatedPosts($content){
  ...
  function registerRestRoutes()
  {
    register_rest_route('featuredProfessor/v1', '/getHTML', array(
      ...
      'callback' => [$this, 'getProHTML'],
      'permission_callback' => '__return_true' // Optionally add permissions callback
    ));
  }

  function getProHTML($data)
  {
  ...
  {
    if (isset($attributes['profId']) && $attributes['profId']) {
